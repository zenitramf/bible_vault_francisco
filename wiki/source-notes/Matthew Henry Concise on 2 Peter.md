---
type: Source Note
title: Matthew Henry Concise on 2 Peter
...
# Matthew Henry Concise on 2 Peter
...
- 2 Peter is synthesized chapter-by-chapter from Matthew Henry Concise for wiki retrieval without source RAG. See [[wiki/passages/2 Peter 1|2 Peter 1]] through [[wiki/passages/2 Peter 3|2 Peter 3]].
- Material claims on each passage page cite the corresponding concise chapter file. [[sources/commentaries_english/mhenry-concise/2-peter/chapter-1|Matthew Henry Concise, chapter 1 sample]]
...
2 Peter (full book scope in the atlas).

## Related pages

- [[wiki/passages/2 Peter 1|2 Peter 1]] through [[wiki/passages/2 Peter 3|2 Peter 3]]
