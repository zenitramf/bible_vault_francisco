---
type: Source Note
title: Matthew Henry Concise on Colossians
...
# Matthew Henry Concise on Colossians
...
- Colossians is synthesized chapter-by-chapter from Matthew Henry Concise for wiki retrieval without source RAG. See [[wiki/passages/Colossians 1|Colossians 1]] through [[wiki/passages/Colossians 4|Colossians 4]].
- Material claims on each passage page cite the corresponding concise chapter file. [[sources/commentaries_english/mhenry-concise/colossians/chapter-1|Matthew Henry Concise, chapter 1 sample]]
...
Colossians (full book scope in the atlas).

## Related pages

- [[wiki/passages/Colossians 1|Colossians 1]] through [[wiki/passages/Colossians 4|Colossians 4]]
